				...
				for(var i = 0; i < tests.length; i++){
					...
					// Fill some data 
					  ...
					  if(tests[i].start_date != null && tests[i].end_date != null &&
	  					_.isNumber(parseInt(tests[i].start_date)) && _.isNumber(parseInt(tests[i].end_date)) &&
	  					_.isDate(new Date(parseInt(tests[i].start_date))) && _.isDate(new Date(tests[i].end_date)) &&
	  					tests[i].start_date >= tests[i].end_date){
